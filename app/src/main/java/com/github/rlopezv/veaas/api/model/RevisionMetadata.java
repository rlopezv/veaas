...
public class RevisionMetadata   {
  ...
  public RevisionMetadata author(String author) {
    this.author = author;
    return this;
  }
 ...
 @Schema(defaultValue = "who authored this revision, typically their name and email, e.g. \"John Doe <john_doe@my-company.com>\",")
  ...
  public RevisionMetadata date(Time date) {
    this.date = date;
    return this;
  }
 ...
 @Schema(defaultValue = "")
  ...
  public RevisionMetadata message(String message) {
 ...
 @Schema(defaultValue = "Message contains the message associated with the revision, most likely the commit message. The message is truncated to the first newline or 64 characters (which ever comes first)")
  ...
  public RevisionMetadata tags(List<String> tags) {
    this.tags = tags;
    return this;
  }

  public RevisionMetadata addTagsItem(String tagsItem) {
    if (this.tags == null) {
 ...
 @Schema(defaultValue = "Tags specifies any tags currently attached to the revision Floating tags can move from one revision to another")
  ...
  public boolean equals(Object o) {
    ...
    RevisionMetadata RevisionMetadata = (RevisionMetadata) o;
    return Objects.equals(this.author, RevisionMetadata.author) &&
        Objects.equals(this.date, RevisionMetadata.date) &&
        Objects.equals(this.message, RevisionMetadata.message) &&
        Objects.equals(this.tags, RevisionMetadata.tags);
  }
  ...
  public String toString() {
    ...
    sb.append("class RevisionMetadata {\n");
