...
public class WorkSpaceLogEntry   {
  ...
  public WorkSpaceLogEntry content(String content) {
 ...
 public String getContent() {
  ...
  public WorkSpaceLogEntry last(Boolean last) {
    this.last = last;
    return this;
  }
 ...
 public Boolean getLast() {
  ...
  public WorkSpaceLogEntry deviceName(String deviceName) {
 ...
 public String getDeviceName() {
  ...
  public WorkSpaceLogEntry timeStamp(Time timeStamp) {
 ...
 @Schema(defaultValue = "")
  ...
  public WorkSpaceLogEntry timeStampStr(String timeStampStr) {
 ...
 public String getTimeStampStr() {
  ...
  public boolean equals(Object o) {
    ...
    WorkSpaceLogEntry workSpaceLogEntry = (WorkSpaceLogEntry) o;
  ...
  public String toString() {
    ...
    sb.append("class WorkSpaceLogEntry {\n");
