...
public interface RepositoryApi {
    ...
    /**
     * POST {source.repoURL}/appdetails : GetAppDetails returns workSpace details by given path
     *
     ...
     */
    @Operation(summary = "Returns workSpace details by given path", operationId = "repositoryServiceGetAppDetails",  tags={ "RepositoryService", })
    @ApiResponses(value = { 
    ...
    @PostMapping(
        value = "{source}/workspace-details",
    ...
    /**
     * GET {repo}/workSpaces : ListApps returns list of workSpaces in the repo
     *
     * @param repo  (required)
     ...
     *         or An unexpected error response. (status code 500)
     */
    @Operation(summary = "returns list of workSpaces in the repo", operationId = "repositoryServiceListApps",  tags={ "RepositoryService", })
    @ApiResponses(value = { 
    ...
    /**
     * GET repositories : ListRepositories gets a list of all configured repositories
     *
    ...
    /**
     * PUT {repo.repo} : UpdateRepository updates a repository configuration
     *
    ...
    default ResponseEntity<Repository> _repositoryServiceUpdateRepository(@Parameter(example = "Repo contains the URL to the remote repository",required=true) @PathVariable("repo") String repoRepo,@Parameter(example = "" ,required=true )  @Valid @RequestBody Repository body) {
    ...
    /**
     * POST {repo}/validate : ValidateAccess validates access to a repository with given parameters
     *
