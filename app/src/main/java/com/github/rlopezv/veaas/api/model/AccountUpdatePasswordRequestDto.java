...
public class AccountUpdatePasswordRequestDto   {
  ...
  public AccountUpdatePasswordRequestDto currentPassword(String currentPassword) {
 ...
 @Schema(defaultValue = "")
  ...
  public AccountUpdatePasswordRequestDto name(String name) {
    this.name = name;
    return this;
  }
 ...
 @Schema(defaultValue = "")
  ...
  public AccountUpdatePasswordRequestDto newPassword(String newPassword) {
 ...
 @Schema(defaultValue = "")
  ...
  public boolean equals(Object o) {
    ...
    AccountUpdatePasswordRequestDto accountUpdatePasswordRequest = (AccountUpdatePasswordRequestDto) o;
  ...
  public String toString() {
    ...
    sb.append("class AccountUpdatePasswordRequestDto {\n");
