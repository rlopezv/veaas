...
public class WorkSpaceWorkSpaceSyncRequest   {
  @JsonProperty("dryRun")
  ...
  private WorkSpaceSyncOptions syncOptions;

  public WorkSpaceWorkSpaceSyncRequest dryRun(Boolean dryRun) {
    this.dryRun = dryRun;
    return this;
  }
 ...
 public Boolean getDryRun() {
  ...
  public WorkSpaceWorkSpaceSyncRequest infos(List<Info> infos) {
    this.infos = infos;
    return this;
  }

  public WorkSpaceWorkSpaceSyncRequest addInfosItem(Info infosItem) {
    if (this.infos == null) {
 ...
 @Schema(defaultValue = "")
  ...
  public WorkSpaceWorkSpaceSyncRequest manifests(List<String> manifests) {
    this.manifests = manifests;
    return this;
  }

  public WorkSpaceWorkSpaceSyncRequest addManifestsItem(String manifestsItem) {
 ...
 public List<String> getManifests() {
  ...
  public WorkSpaceWorkSpaceSyncRequest name(String name) {
    this.name = name;
    return this;
  }
 ...
 public String getName() {
  ...
  public WorkSpaceWorkSpaceSyncRequest prune(Boolean prune) {
    this.prune = prune;
    return this;
  }
 ...
 public Boolean getPrune() {
  ...
  public WorkSpaceWorkSpaceSyncRequest resources(List<SyncOperationResource> resources) {
    this.resources = resources;
    return this;
  }

  public WorkSpaceWorkSpaceSyncRequest addResourcesItem(SyncOperationResource resourcesItem) {
 ...
 @Schema(defaultValue = "")
  ...
  public WorkSpaceWorkSpaceSyncRequest retryStrategy(RetryStrategy retryStrategy) {
 ...
 @Schema(defaultValue = "")
  ...
  public WorkSpaceWorkSpaceSyncRequest revision(String revision) {
 ...
 public String getRevision() {
  ...
  public WorkSpaceWorkSpaceSyncRequest strategy(SyncStrategy strategy) {
 ...
 @Schema(defaultValue = "")
  ...
  public WorkSpaceWorkSpaceSyncRequest syncOptions(WorkSpaceSyncOptions syncOptions) {
 ...
 @Schema(defaultValue = "")
  ...
  public WorkSpaceSyncOptions getSyncOptions() {
    return syncOptions;
  }

  public void setSyncOptions(WorkSpaceSyncOptions syncOptions) {
    this.syncOptions = syncOptions;
  }
  ...
  public boolean equals(Object o) {
    ...
    WorkSpaceWorkSpaceSyncRequest workSpaceWorkSpaceSyncRequest = (WorkSpaceWorkSpaceSyncRequest) o;
  ...
  public String toString() {
    ...
    sb.append("class WorkSpaceWorkSpaceSyncRequest {\n");
