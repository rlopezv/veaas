...
public class WorkSpaceWorkSpacePatchRequest   {
  @JsonProperty("name")
  private String name;
  ...
  public WorkSpaceWorkSpacePatchRequest name(String name) {
    this.name = name;
    return this;
  }
 ...
 public String getName() {
  ...
  public WorkSpaceWorkSpacePatchRequest patch(String patch) {
    this.patch = patch;
    return this;
  }
 ...
 public String getPatch() {
  ...
  public WorkSpaceWorkSpacePatchRequest patchType(String patchType) {
 ...
 public String getPatchType() {
  ...
  public boolean equals(Object o) {
    ...
    WorkSpaceWorkSpacePatchRequest workSpaceWorkSpacePatchRequest = (WorkSpaceWorkSpacePatchRequest) o;
  ...
  public String toString() {
    ...
    sb.append("class WorkSpaceWorkSpacePatchRequest {\n");
