...
public class ObjectReference   {
 ...
 @Schema(defaultValue = "UID of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#uids +optional")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.apiVersion, ObjectReference.apiVersion) &&
        Objects.equals(this.fieldPath, ObjectReference.fieldPath) &&
        Objects.equals(this.kind, ObjectReference.kind) &&
        Objects.equals(this.name, ObjectReference.name) &&
        Objects.equals(this.namespace, ObjectReference.namespace) &&
        Objects.equals(this.resourceVersion, ObjectReference.resourceVersion) &&
        Objects.equals(this.uid, ObjectReference.uid);
  }
